...
// Hook for managing popup timing and scroll detection
  ...
  useEffect(() => {
    ...
    const checkScrollPosition = () => {
      ...
      if (searchResultsElement) {
        const rect = searchResultsElement.getBoundingClientRect();
        const isVisible = rect.top < window.innerHeight && rect.bottom > 0;
        
        if (isVisible && !hasScrolledToResults) {
          hasScrolledToResults = true;
          
          // Show popup after 1 second of being in the search results section
    ...
    // Initial delay before starting to check scroll position (5 seconds after load)
