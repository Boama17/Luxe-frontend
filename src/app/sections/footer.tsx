...
function Footer({ background = 'bg-white' }: FooterProps) {
  return (
    <div>
      <footer className={`${background} font-[Poppins-regular] text-gray-800 py-6 border-t border-gray-200`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-600 hover:text-emerald-800 transition-colors">
          ...
          <div className="mt-6 pt-6 border-t border-emerald-950 flex flex-col md:flex-row justify-between">
