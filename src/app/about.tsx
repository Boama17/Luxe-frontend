...
export default function About() {
  return (
    <div className="cont bg-white pb-12 font-sans">
      <div className="hero flex flex-col lg:flex-row items-center lg:items-start px-6 lg:px-12 md:pt-24 pt-12">
        <div className="flex items-center me-12 mb-8 lg:mb-0">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                        className='size-14 mx-auto'viewBox="0 0 300.000000 300.000000"
        ...
        <p className="lg:ms-auto lg:me-auto font-[Poppins-regular] leading-loose font-bold lg:max-w-[41rem] text-base text-center lg:text-left">
          We believe that finding the perfect home or office space should be an enjoyable and stress-free experience. Our team of dedicated professionals brings a wealth of knowledge and experience to the table. With a deep understanding of the <br /> local market and a commitment to personalized service, we strive to make every transaction seamless and satisfying.
        </p>
      </div>
  ...
  <div className="card bg-[#e8f9e8] p-8 w-full h-auto min-h-[28rem] rounded-2xl transition-transform transform hover:scale-105 hover:shadow-lg">
    <img src={green.src} className="mx-auto" alt="" />
  ...
  <img src={purple.src} className="mx-auto" alt="" />
    <h2 className="mt-6 text-3xl font-[Poppins] text-left">Extensive Network</h2>
    <p className="text-sm mt-4 leading-[1.5rem] text-left text-gray-600 font-[Poppins-regular] ">
  ...
  <img src={amber.src} className="mx-auto" alt="" />
    <h2 className="mt-6 text-3xl font-[Poppins] text-left">Top-Notch Customer Service</h2>
    <p className="text-sm mt-4 leading-[1.5rem] text-left text-gray-600 font-[Poppins-regular]">
