...
135 43 130 9 -3 12 -54 12 -213z"/>
    ...
    <div className="sales flex mt-5">
       <div className="sale1">
       <div className="house_1 w-[28rem] h-[18rem] rounded-2xl ml-24"></div>
       <div className="flex h-12 w-[22rem] ml-36 rounded-3xl -mt-16 bg-[#ffffffbb]">
       <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="200.000000pt" height="200.000000pt" viewBox="0 0 200.000000 200.000000" className="size-10 mt-0.5 ml-2"
 preserveAspectRatio="xMidYMid meet">
...
52 115 52 57 0 95 -4 103 -12z"/>
        ...
        <span className="text-xs font-[Poppins-Regular] mt-4 ml-2 mr-1 flex">7 Bedroom</span>
     <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="1320.000000pt" height="880.000000pt" viewBox="0 0 1320.000000 880.000000" className="size-10 mt-1"
 preserveAspectRatio="xMidYMid meet">
...
170 -154 313 -154 317 0 5 986 9 2205 9 l2205 0 0 -27z"/>
        ...
        <span className="text-xs font-[Poppins-Regular] mt-4 mr-1 flex">10 Bathrooms</span>
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="200.000000pt" height="200.000000pt" viewBox="0 0 200.000000 200.000000" className="size-7 mt-2 ml-2"
 preserveAspectRatio="xMidYMid meet">
...
-160 0 c-88 0 -160 3 -160 7 0 4 64 72 142 150 l143 143 363 0 363 0 -3 -147z"/>
        ...
        <span className="text-xs font-[Poppins-Regular] mt-4 mr-1 flex">720 ft²</span>
       </div>
       <div className="descr">
       <div className="head font-[Poppins] mt-10 text-2xl">
        <span className="ml-24">Family House</span> <span className="ml-36 text-green-900"><b>＄</b>450,000</span>
       </div>
       <div className="small text-sm font-[Poppins-Regular] mt-8 ml-24">
        123 Maple Avenue Springfield IL 62704, Los Angeles, California
       </div>
       </div>
       </div>
       <div className="sale2">
       <div className="house_2 w-[28rem] h-[18rem] rounded-2xl ml-8"></div>
       <div className="flex h-12 w-[22rem] ml-[5rem] rounded-3xl -mt-16 bg-[#ffffffbb]">
       <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="200.000000pt" height="200.000000pt" viewBox="0 0 200.000000 200.000000" className="size-10 mt-0.5 ml-2"
 preserveAspectRatio="xMidYMid meet">
...
-160 0 c-88 0 -160 3 -160 7 0 4 64 72 142 150 l143 143 363 0 363 0 -3 -147z"/>
       ...
       <div className="descr">
       <div className="head font-[Poppins] mt-10 text-2xl">
        <span className="ml-10">Family House</span> <span className="ml-36 text-green-900"><b>＄</b>450,000</span>
       </div>
       <div className="small text-sm font-[Poppins-Regular] mt-8 ml-10">
        123 Maple Avenue Springfield IL 62704, Los Angeles, California
       </div>
       </div>
       </div>
       <div className="sale3">
       <div className="house_3 w-[28rem] h-[18rem] rounded-2xl ml-8"></div>
       <div className="flex h-12 w-[22rem] ml-[5rem] rounded-3xl -mt-16 bg-[#ffffffbb]">
       <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="200.000000pt" height="200.000000pt" viewBox="0 0 200.000000 200.000000" className="size-10 mt-0.5 ml-2"
 preserveAspectRatio="xMidYMid meet">
