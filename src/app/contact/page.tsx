              ...
              <div className="group p-6 bg-white/70 backdrop-blur-sm rounded-2xl border border-sky-100 hover:border-sky-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sky-600 text-sm truncate">calebasiedu100@gmail.com</p>
                  </div>
                </div>
              </div>
                  ...
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full py-3 px-6 bg-gradient-to-r from-sky-400 to-gray-400 text-white font-semibold rounded-xl hover:from-sky-500 hover:to-gray-500 focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                      >
